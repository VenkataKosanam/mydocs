...
public class FileDownloader {
	...
	public static void main(String[] args) {
		FileDownloader fd = new FileDownloader(false);
		
		try{
			URL u = new URL("http://chromedriver.storage.googleapis.com/2.23/chromedriver_win32.zip");
		File f = fd.attemptToDownload(u);
...
//    DetectProxyConfig proxyConfig;
    ...
    FileDownloader(boolean useSystemProxy)  {
        this.useSystemProxy = useSystemProxy;
        if (this.useSystemProxy) {
//            proxyConfig = new DetectProxyConfig();
        }
        this.downloadDirectory = "C:\\Users\\Mokshitha\\Venkat\\workplace\\FileDownloaer\\Down";
    }
...
//            LOG.error("Problem downloading '" + filename + "'... " + ex.getCause().getLocalizedMessage());
     ...
     */
//    private String localFilePath(File downloadDirectory)  {
